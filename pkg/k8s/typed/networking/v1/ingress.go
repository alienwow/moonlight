...
type IngressHelper struct {
	client NetworkingV1Interface
}

func NewIngressHelper(client NetworkingV1Interface) IngressHelper {
...
func (ing IngressHelper) NewIngress(material union_interface.IngressMaterial) interface{} {
	...
	ingressBackend := IngressBackend{
		Service: &IngressServiceBackend{
			Name: material.Backend.ServiceName,
			Port: ServiceBackendPort{
				Number: int32(material.Backend.ServicePort),
			},
		},
	}
	var domains []string
