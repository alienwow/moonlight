module github.com/ping-cloudnative/moonlight
...
require (
	...
	github.com/ping-cloudnative/moonlight/proto-go v0.0.0
...
replace (
	...
	github.com/ping-cloudnative/moonlight/proto-go v0.0.0 => ./api/proto-go
