...
var GITTAR_COMMITS_CREATE = apis.ApiSpec{
	Path:         "/api/gittar/<org>/<repo>/commits",
	BackendPath:  "/<org>/<repo>/commits",
	Host:         "gittar.marathon.l4lb.thisdcos.directory:5566",
	Scheme:       "http",
	Method:       "POST",
	CheckLogin:   true,
	IsOpenAPI:    true,
	RequestType:  apistructs.GittarCreateCommitRequest{},
	ResponseType: apistructs.GittarCreateCommitResponse{},
