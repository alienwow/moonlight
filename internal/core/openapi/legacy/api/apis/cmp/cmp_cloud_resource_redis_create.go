...
var CMP_CLOUD_RESOURCE_REDIS_CREATE = apis.ApiSpec{
	...
	Method:       "POST",
	CheckLogin:   true,
	RequestType:  apistructs.CreateCloudResourceRedisRequest{},
	ResponseType: apistructs.CreateCloudResourceRedisResponse{},
	Doc:          "创建 redis",
	Audit: func(ctx *spec.AuditContext) error {
		var request apistructs.CreateCloudResourceRedisRequest
		...
		return ctx.CreateAudit(&apistructs.Audit{
			...
			TemplateName: apistructs.CreateRedisTemplate,
