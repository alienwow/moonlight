...
var CMP_CLOUD_RESOURCE_MYSQL_ACCOUNT_CREATE = apis.ApiSpec{
	Path:         "/api/cloud-mysql/actions/create-account",
	BackendPath:  "/api/cloud-mysql/actions/create-account",
	...
	Audit: func(ctx *spec.AuditContext) error {
		var request apistructs.CreateCloudResourceMysqlAccountRequest
		...
		return ctx.CreateAudit(&apistructs.Audit{
			...
			TemplateName: apistructs.CreateMysqlAccountTemplate,
