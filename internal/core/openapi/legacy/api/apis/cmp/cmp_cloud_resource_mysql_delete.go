...
var CMP_CLOUD_RESOURCE_MYSQL_DELETE = apis.ApiSpec{
	...
	Method:       "DELETE",
	CheckLogin:   true,
	RequestType:  apistructs.DeleteCloudResourceMysqlRequest{},
	ResponseType: apistructs.CloudAddonResourceDeleteRespnse{},
	Doc:          "删除 mysql",
	Audit: func(ctx *spec.AuditContext) error {
		var request apistructs.DeleteCloudResourceMysqlRequest
		...
		return ctx.CreateAudit(&apistructs.Audit{
			...
			TemplateName: apistructs.DeleteMysqlTemplate,
