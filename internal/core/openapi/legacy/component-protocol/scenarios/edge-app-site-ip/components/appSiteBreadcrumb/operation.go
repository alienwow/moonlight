...
type ComponentBreadCrumb struct {
	ctxBundle protocol.ContextBundle
	component *apistructs.Component
}

func (c *ComponentBreadCrumb) SetBundle(ctxBundle protocol.ContextBundle) error {
...
func (c *ComponentBreadCrumb) SetComponent(component *apistructs.Component) error {
	if component == nil {
		return fmt.Errorf("invalie bundle")
	}
