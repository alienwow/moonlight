...
func init() {
	base.InitProviderWithCreator("issue-dashboard", "severityPieChart",
...
func (f *ComponentAction) Render(ctx context.Context, c *cptype.Component, scenario cptype.Scenario, event cptype.ComponentEvent, gs *cptype.GlobalStateData) error {
	...
	pie.Colors = colors
	pie.AddSeries(cputil.I18n(ctx, "severity"), seriesData, common.GetPieSeriesOpt())
	props := make(map[string]interface{})
	props["title"] = cputil.I18n(ctx, "severityPieChartTitle")
	props["chartType"] = "pie"
