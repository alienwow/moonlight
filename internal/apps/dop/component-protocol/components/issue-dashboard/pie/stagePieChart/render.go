...
import (
	...
	"github.com/ping-cloudnative/moonlight/internal/apps/dop/component-protocol/components/issue-dashboard/common/gshelper"
...
func (f *ComponentAction) Render(ctx context.Context, c *cptype.Component, scenario cptype.Scenario, event cptype.ComponentEvent, gs *cptype.GlobalStateData) error {
	...
	handler := stackhandlers.NewStageStackHandler(false, helper.GetIssueStageList())
	...
	pie.Colors = colors
	pie.AddSeries(cputil.I18n(ctx, "import-source"), seriesData, common.GetPieSeriesOpt())
	props := make(map[string]interface{})
	props["title"] = cputil.I18n(ctx, "stagePieChartitle")
	props["chartType"] = "pie"
