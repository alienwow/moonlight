...
func init() {
	base.InitProviderWithCreator("issue-dashboard", "month",
	...
	f.OverviewProps = common.OverviewProps{
		...
		Value: common.OverviewValue{
			...
			Text: []common.OverviewText{
				...
				{
					Text: cputil.I18n(ctx, "dueThisMonth"),
					StyleConfig: common.StyleConfig{
						Color: "text-desc",
					},
					Icon:    "help",
					IconTip: cputil.I18n(ctx, "notIncludeDueTodayTomorrowMonth"),
				},
			},
		},
	}
