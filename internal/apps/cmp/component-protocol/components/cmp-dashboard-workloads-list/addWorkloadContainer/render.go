...
func init() {
	base.InitProviderWithCreator("cmp-dashboard-workloads-list", "addWorkloadContainer", func() servicehub.Provider {
		return &ComponentAddWorkloadContainer{}
	})
}

func (c *ComponentAddWorkloadContainer) Render(ctx context.Context, component *cptype.Component, _ cptype.Scenario,
