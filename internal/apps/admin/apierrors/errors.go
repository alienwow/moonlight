...
var (
	...
	ErrCreateCloudAccount                   = err("ErrCreateCloudAccount", "创建云账号失败")
	ErrUpdateCloudAccount                   = err("ErrUpdateCloudAccount", "更新云账号失败")
	ErrDeleteCloudAccount                   = err("ErrDeleteCloudAccount", "删除云账号失败")
	ErrListCloudAccount                     = err("ErrListCloudAccount", "获取云账号列表失败")
	ErrGetCloudAccount                      = err("ErrGetCloudAccount", "获取云账号失败")
