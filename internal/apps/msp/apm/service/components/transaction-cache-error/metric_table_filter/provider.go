...
import (
	...
	error_transaction "github.com/ping-cloudnative/moonlight/internal/apps/msp/apm/service/common/error-transaction"
...
func init() {
	name := "component-protocol.components.transaction-cache-error.metricTableFilter"
	cpregister.AllExplicitProviderCreatorMap[name] = nil
	base.InitProviderWithCreator("transaction-cache-error", "metricTableFilter",
