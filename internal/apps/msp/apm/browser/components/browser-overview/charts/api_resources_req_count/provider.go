...
package api_resources_req_count
...
import (
	...
	"github.com/ping-cloudnative/moonlight/internal/apps/msp/apm/browser/components/browser-overview/charts/utils"
	"github.com/ping-cloudnative/moonlight/internal/apps/msp/apm/browser/components/browser-overview/models"
	"github.com/ping-cloudnative/moonlight/pkg/common/apis"
	metricpb "github.com/ping-cloudnative/moonlight/proto-go/core/monitor/metric/pb"
)

const chartName = "reqCount"
...
func (p *provider) Init(ctx servicehub.Context) error {
	...
	compName := "apiAndResourcesReqCountLine"
	if ctx.Label() != "" {
		compName = ctx.Label()
	}
...
func init() {
	name := "component-protocol.components.browser-overview.apiAndResourcesReqCountLine"
