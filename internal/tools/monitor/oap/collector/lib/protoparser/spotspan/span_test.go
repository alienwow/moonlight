...
func Test_unmarshalWork_Unmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "parse error",
			fields: fields{
				buf: []byte(`"name":"aaa","timestamp":1652756014793553000,"tags":{"org_name":"erda","parent_span_id":"","span_id":"aaa","trace_id":"bbb"},"fields":{"end_time":1652756014793553000,"start_time":1652756014793553000}}`),
			},
			want: &trace.Span{
				SpanId:        "aaa",
				TraceId:       "bbb",
