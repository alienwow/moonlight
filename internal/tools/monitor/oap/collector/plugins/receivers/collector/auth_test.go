...
////go:generate mockgen -destination=./collector_validator_test.go -package collector github.com/ping-cloudnative/moonlight/internal/tools/monitor/oap/collector/authentication Validator
